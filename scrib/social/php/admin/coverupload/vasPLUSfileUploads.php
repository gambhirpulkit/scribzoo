		  ...
		  else 
		  {
			  if($size<(1024*1024))
			  {
				  ...
				  { 
					 ...
					 $qry = mysql_query("update posts set imgname = '$actual_image_name' where pid = '80'");
	
					echo '<span class="uploadeFileWrapper"><img src="'.$upload_location.$actual_image_name.'" width="625" height="250"></span><br clear="all" /><br clear="all" />';
				  }
				  else 
				  {
