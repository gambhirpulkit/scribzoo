...
<!-- Mirrored from cdn2.mosaicpro.biz/social/php/admin/login.html?lang=en&v=v2.0.1-rc1&layout_fixed=false&navbar_type=navbar-inverse&skin=burnt-sienna by HTTrack Website Copier/3.x [XR&CO'2013], Sat, 21 Jun 2014 11:36:32 GMT -->
...
<head>
	...
	**********************************************************
	<link rel="stylesheet/less" href="../assets/less/skins/module.admin.stylesheet-complete.layout_fixed.false.skin.burnt-sienna.less" />
	-->
        ...
        <link rel="stylesheet" href="../assets/less/pages/serveStyles0785.css?module=admin&amp;page=login&amp;url_rewrite=&amp;lang=en&amp;v=v2.0.1-rc1&amp;layout_fixed=false&amp;navbar_type=navbar-inverse&amp;skin=burnt-sienna" />
         <link rel="stylesheet" href="../assets/less/pages/reset.css">

    <link rel="stylesheet" href="../assets/less/pages/style.css" media="screen" type="text/css" />
    ...
    <script src="../../../shared/assets/library/jquery/jquery.min9479.js?v=v2.0.1-rc1&amp;sv=v0.0.1.2"></script>
<script src="../../../shared/assets/library/jquery/jquery-migrate.min9479.js?v=v2.0.1-rc1&amp;sv=v0.0.1.2"></script>
<script src="../../../shared/assets/library/modernizr/modernizr9479.js?v=v2.0.1-rc1&amp;sv=v0.0.1.2"></script>
<script src="../../../shared/assets/plugins/core_less-js/less.min9479.js?v=v2.0.1-rc1&amp;sv=v0.0.1.2"></script>
<script src="../../../shared/assets/plugins/charts_flot/excanvas9479.js?v=v2.0.1-rc1&amp;sv=v0.0.1.2"></script>
<script src="../../../shared/assets/plugins/core_browser/ie/ie.prototype.polyfill9479.js?v=v2.0.1-rc1&amp;sv=v0.0.1.2"></script>    <script>if (/*@cc_on!@*/false && document.documentMode === 10) { document.documentElement.className+=' ie ie10'; }</script>
...
<div id="menu-right">
				...
				<ul>
					...
					<li class="conversation innerAll">
						...
						<div class="media">
							...
							<div class="media-object pull-left"><img src="../assets/images/people/50/.jpg" alt="Image" class="img-circle" /></div>
					...
					<ul>
						...
						<li>
								...
								<div class="media-body">
									...
									<small>Hey, the party is on tonight!</small>
	a-toggle="tab" class="pull-right text-muted innerT half">
										<i class="fa fa-comments"></i> 4
									</a>
	...
	<fieldset>
		...
		<input type="button" name="submit"  class="next action-button" value="Login" /><BR>
		<h3 class="">Not a member? <a href="register.html">Join us today!</a></h3>
	</fieldset>
    ...
    <script src="../../../shared/assets/library/bootstrap/js/bootstrap.min9479.js?v=v2.0.1-rc1&amp;sv=v0.0.1.2"></script>
<script src="../../../shared/assets/plugins/core_nicescroll/jquery.nicescroll.min9479.js?v=v2.0.1-rc1&amp;sv=v0.0.1.2"></script>
<script src="../../../shared/assets/plugins/core_breakpoints/breakpoints9479.js?v=v2.0.1-rc1&amp;sv=v0.0.1.2"></script>
<script src="../../../shared/assets/plugins/core_preload/pace.min9479.js?v=v2.0.1-rc1&amp;sv=v0.0.1.2"></script>
<script src="../../../shared/assets/components/core_preload/preload.pace.init9479.js?v=v2.0.1-rc1&amp;sv=v0.0.1.2"></script>
<script src="../assets/plugins/menu_sidr/jquery.sidr7359.js?v=v2.0.1-rc1"></script>
<script src="../assets/components/menus/menus.sidebar.chat.init7359.js?v=v2.0.1-rc1"></script>
<script src="../../../shared/assets/plugins/other_mixitup/jquery.mixitup.min9479.js?v=v2.0.1-rc1&amp;sv=v0.0.1.2"></script>
<script src="../../../shared/assets/plugins/other_mixitup/mixitup.init9479.js?v=v2.0.1-rc1&amp;sv=v0.0.1.2"></script>
<script src="../assets/components/core/core.init7359.js?v=v2.0.1-rc1"></script>
<!-- jQuery -->
...
<!-- Mirrored from cdn2.mosaicpro.biz/social/php/admin/login.html?lang=en&v=v2.0.1-rc1&layout_fixed=false&navbar_type=navbar-inverse&skin=burnt-sienna by HTTrack Website Copier/3.x [XR&CO'2013], Sat, 21 Jun 2014 11:36:34 GMT -->
</html>