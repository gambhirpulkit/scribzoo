	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-7 col-sm-7 intro-section">
				...
				<strong>WRITE, SHARE, EXPLORE</strong> and <strong>AUTHENTICATE</strong> testimonials  about people around you.					</h3>
			...
			<div class="col-md-5 col-sm-5">
				...
				<div class="vertical-registration-form">
					...
					<a href="fbconnect.php" class="fb-login">Register with Facebook</a><BR>
					<h4>OR</h4> 
					<h3>CREATE YOUR ACCOUNT</h3>
						<?php if($var=='email_already_exists')
						{ ?> <span style="float:left; color:red; ">*Email already exists </span>
						<?php }elseif($var == 'username_already_exists'){ ?>
						<span style="float:left; color:red; ">*Username already exists </span>
						<?php } ?>
					<form class="registration-form" id="register" action="fill_details_register.php" method="post" role="form">
<input class="form-control input-box"  type="name" name="username" id="username" placeholder="Please select a username" onBlur="check_username();">
	<?php if($var='') { ?>
						...
						<button class="btn standard-button" type="submit" id="submit" name="submit">Register
</button>
					</form>
