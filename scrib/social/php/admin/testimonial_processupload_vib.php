...
if(isset($_POST))
{
	...
	if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
	{
		...
		*/
		...
		echo '<tr>';
		//echo '<td align="center"><img src="imageupload/uploads_testimonial/'.$ThumbPrefix.$NewImageName.'" alt="Thumbnail"></td>';
		//echo '</tr><tr>';
	...
	//	echo '</tr>';
		...
		*/	
				...
				$result_sel=mysql_fetch_array($qry_sel);
				 ...
				 $qry = mysql_query("update posts set imgname = '$ThumbPrefix$NewImageName' where  s_email = '{$_SESSION['SESS_EMAIL']}' and pid='{$result_sel['pid']}'");
