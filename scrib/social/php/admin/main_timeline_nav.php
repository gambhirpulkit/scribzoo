...
$qry_type=mysql_query("select t1.* from tbl_activity t1 where verb='shared a testimonial' or verb='wrote a testimonial' or verb='voted a testimonial' order by date desc limit 3");

while($result_type=mysql_fetch_array($qry_type))
{
$allowed_user = explode(",", $result_type['activity_id']);
...
?>
  ...
  <!--shared area starts -->
<?php if($result_type['verb']=='shared a testimonial' && in_array($visitor_id,$allowed_user))
{	
...
<?php if($result_share['imgname']!= ''){ ?>
	   ...
	   <? }
	   if($result_type['verb']=='voted a testimonial' && in_array($visitor_id,$allowed_user))
	   {
...
<div class="widget">
 ...
 $result_pic=mysql_fetch_array($qry_pic);
  ...
  <?php 
			...
			<a href="image_upload_fb.php"><img src="https://graph.facebook.com/<? echo $_SESSION['SESS_USER']; ?>/picture?type=large" width="120" alt="" data-toggle="tooltip" data-original-title="click to change picture" data-placement="right" class="img-circle"></a>
 ...
 <?php }
			...
			<a href="image_upload.php" ><img src="imageupload/uploads/<?php echo $result_pic['profile_pic']; ?>" width="120" alt="" data-toggle="tooltip" data-original-title="Click to change picture" data-placement="right" class="img-circle"></a>
