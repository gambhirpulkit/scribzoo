...
<div class="widget gridalicious-item not-responsive " >
    ...
    <div class="bg-gray  border-bottom innerAll">
		...
		<a href="#" class="pull-right innerT text-primary">			
           <span class="text-primary strong lead pull-left innerT innerR half "><i class="icon-time-clock" data-toggle="tooltip" fata-placement="top" data-title=""></i></span>
        </a>
		
		
		<i class="fa fa-quote-left text-muted pull-left fa-fw"></i> 
        <a href="" class="lead strong display-block margin-none">""</a>
		
        <span>&nbsp; &nbsp; Written by <a href="#">""</a>&nbsp;for <a href="#">""</a></span>
    </div>
...
src="http://www.youtube.com/embed/<?php echo $result_name['home_page'];?>">
</iframe>
