...
// we are getting email adress from session here
						  $result_track_share = mysql_fetch_array(mysql_query("select id from track_share where sharer = '2' and testimonial_id = '$pid'")); 
 ...
 <a href="#" return false; id="before_sharing" style="float:right" onclick="share('<?php echo $pid ?>','2'); update_count_share();" data-original-title="share this testimonial"></i><h5>&nbsp;&nbsp;Share &nbsp;</h5></a>
<p id="after_sharing" style="float:right;display:none">You shared this &nbsp;</p>
 <?php }else{ ?>

							   <a href="#"return false; id="before_unsharing" style="float:right;display:none" onClick="share('<?php echo $pid ?>','2'); update_uncount_share();" title="share this testimonial" data-rel="tooltip"><i class="icon icon-carat-1-n "></i>share</a>
...
//getting session email from session
						  ...
						  $result_track_vote = mysql_fetch_array(mysql_query("select id from track_votes where voter = '2' and testimonial_id = '$pid'")); 
		   ...
		   <a href="#" id="before_voting" style="float:right" onClick="vote_up('<?php echo $pid ?>',2); update_count();" data-rel="tooltip" data-original-title="Vote up this testimonial"></i><h5>&nbsp;&nbsp; Vote Up </h5></a>
<p id="after_voting" onClick="unvote('<?php echo $pid ?>',2);update_count_reverse()" style="float:right;display:none">You voted this up &nbsp;<a href="#" >Unvote</a></p>
 <?php }else{ ?>

							   <a href="#" id="before_unvoting" style="float:right;display:none" onClick="vote_up('<?php echo $pid ?>',2); update_uncount();" title="Vote up this testimonial" data-rel="tooltip"><i class="icon icon-carat-1-n "></i>Vote Up</a>

							   <p id="after_unvoting" style="float:right;">You voted this up &nbsp;<a href="#" onClick="unvote('<?php echo $pid ?>',2);update_uncount_reverse()" title="Unvote this testimonial" data-rel="tooltip">Unvote</a></p> 
