...
<script>
function hide_loadmore1()

{

document.getElementById('load_more1').style.display="none";
...
<span id="loadmore1" onclick="load_more('<?php echo $previous_rows; ?>');hide_loadmore1();return false;">Load more</span>
<div id="load_more">
</div>
