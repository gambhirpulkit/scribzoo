...
if(isset($_POST))
{
	...
	$DestinationDirectory	= 'imageupload/uploads/'; //specify upload directory ends with / (slash)
	...
	if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
	{
		...
		*/
		...
		echo '<tr>';
		echo '<td align="center"><img src="imageupload/uploads/'.$ThumbPrefix.$NewImageName.'" alt="Thumbnail"></td>';
		echo '</tr><tr>';
	...
	//	echo '</tr>';
		...
		*/			 $qry = mysql_query("update member set profile_pic = '$ThumbPrefix$NewImageName' where login = '{$_SESSION['SESS_EMAIL']}'");
