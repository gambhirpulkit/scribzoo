...
<?php
$sel = "select * from posts order by pid desc limit 15";
$qry = mysql_query($sel);
...
<?php if($img != ''){?>
	...
	<?php }else{ ?>
	<a href="testimonial.php?id=<?php echo $pid?>" class="pull-left"><img src="imageupload/uploads_testimonial/sample_testimonial_image.jpg" alt="Image" style= "height:100px; width:100px; overflow:hidden;" class="img-responsive" /></a>
	<?php } ?>
...
<div class="widget widget-heading-simple widget-body-white margin-none">
	...
	<table class="table table-vertical-center border-bottom">
		...
		<?php
$sel = "select firstname,lastname,login,m_id,hometown,user,username from member order by rand() limit 15";
$qry = mysql_query($sel);
