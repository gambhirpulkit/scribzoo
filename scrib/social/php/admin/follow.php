...
// we are getting email adress from session here
 ...
 <a href="#" id="before_sharing" style="float:right" onclick="share('<?php echo $pid ?>','<?php echo $_SESSION['SESS_MID'] ?>'); update_count_share();" data-original-title="share this testimonial"></i><h5>&nbsp;&nbsp;Share &nbsp;</h5></a>
