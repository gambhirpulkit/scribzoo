...
<body class=" scripts-async menu-right-hidden">
  ...
  {  
	...
	<h3><?php echo $source ?> related to '<?php echo $keyword; ?>'</h3>
...
<?php
$sel = "select * from posts where description like '%$keyword%' and hide!='1' and deactive_status!='1' order by date_posts desc";
$qry = mysql_query($sel);
...
<?php if($img != ''){?>
	...
	<div class="media-body innerTB half">
		 <a href="testimonial.php?id=<?php echo $pid?>" class="no-ajaxify"><h5 class="strong text-uppercase"><?php echo $title;?></h5></a>
...
<div class="widget widget-heading-simple widget-body-white margin-none">
	...
	<table class="table table-vertical-center border-bottom">
		...
		<?php
$sel = "select firstname,lastname,login,m_id,hometown,user,username from member where firstname like '%$keyword%' or lastname like '%$keyword%' or login like '%$keyword%' limit 10";
$qry = mysql_query($sel);
...
<?php } ?>					
			...
			<br><br>
		<a href="#" id="loadmore_people1" onClick="load_more_people('<?php echo $previous_rows_people; ?>','<?php echo $keyword; ?>'); hide_loadmore_people(); return false;">Load more</a>
<div id="load_more_people">
</div>
		</tbody>
