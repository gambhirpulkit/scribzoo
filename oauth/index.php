...
<br/>
	    <div><b>Visit Tutorial: </b><a style="font-size:17px;" href="http://25labs.com/import-gmail-or-google-contacts-using-google-contacts-data-api-3-0-and-oauth-2-0-in-php/" >Import Gmail or Google contacts using Google Contacts Data API 3.0 and OAuth 2.0 in PHP</a></div>
	        <br/><br/>
        <div align="center" >
        	<a  style="font-size:25px;font-weight:bold;" href="https://accounts.google.com/o/oauth2/auth?client_id=927964971908-v2lfdfsudvs02p18siao9d7sbma9ane2.apps.googleusercontent.com&redirect_uri=http://www.scribzoo.com/oauth/oauth.php&scope=https://www.google.com/m8/feeds/&response_type=code">Click here to Import Gmail Contacts</a>
        </div>
    </body>
</html>